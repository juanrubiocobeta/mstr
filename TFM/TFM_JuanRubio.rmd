...
output: 
  pdf_document:
    ...
    keep_tex: false
bibliography: bibliografia.bib  # <--- AÑADE ESTO
link-citations: yes             # <--- AÑADE ESTO
...
# Configuración global OPTIMIZADA para TFM
knitr::opts_chunk$set(
  echo = TRUE,           # Mostramos código
  message = FALSE,       # Ocultar mensajes
  warning = FALSE,       # Ocultar advertencias
  error = FALSE,         # Que no pare la compilación por errores tontos
  
  # --- CONTROL DE TAMAÑO Y ESPACIO ---
  size = "scriptsize",   # CAMBIO CLAVE: Mucho más pequeño que 'small'
  collapse = TRUE,       # CAMBIO CLAVE: Junta el código y el output en una sola caja
  comment = "#>",        # Estética: Pone "#>" en los resultados
  strip.white = TRUE,    # Elimina líneas blancas sobrantes
  
  # --- CONTROL DE GRÁFICOS ---
  fig.align = "center",
  out.width = "70%",     # Gráficas contenidas
  fig.pos = "H"
)
```
